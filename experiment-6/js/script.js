...
function playSong1() {
  if (!song1Played && !song1.isPlaying()) {
    song1.play();
    background(0, 255, 0);
    console.log("Song 1 is playing because x-coordinate is between 100 and 200 pixels!");
    song1Played = true;
  }
}
...
function playSong2() {
  if (!song2Played && !song2.isPlaying()) {
    song2.play();
    background(0, 0, 255);
    console.log("Song 2 is playing because x-coordinate is between 450 and 500 pixels!");
    song2Played = true;
  }
}
